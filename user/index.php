                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <?php if ($oo->get_plan() != 'pro') { ?>
                            <p>流量可以通过签到获取流量或者直接<span style="font-weight:bold;"><font color="red">购买PRO套餐
                                    </font></span></p>
                        ...
                        <?php if ($oo->get_plan() == 'pro') { ?> <p><span style="font-weight:bold;"><font color="red">PRO用户无需签到，每月15日重置使用流量，到期时间在用户信息中查看</font></span>
                        </p>
                    ...
                    <div class="box-body">
                        ...
                        <div class="progress progress-striped">
                            <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="40"
                                 aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $used_100; ?>%">
