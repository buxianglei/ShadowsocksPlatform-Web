                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo \Ss\User\Comm::Gravatar($U->GetEmail()); ?>" class="user-image"
                                 alt="User Image"/>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="<?php echo \Ss\User\Comm::Gravatar($U->GetEmail()); ?>" class="img-circle"
                                     alt="User Image"/>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="buy.php">
                        <i class="fa fa-shopping-cart"></i> <span>购买套餐</span>
                    </a>
                </li>
